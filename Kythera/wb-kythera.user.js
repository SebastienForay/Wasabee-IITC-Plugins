...
// @id             wb-kythera
// @updateURL      https://github.com/SebastienForay/Wasabee-IITC-Plugins/raw/main/Kythera/wb-kythera.meta.js
// @downloadURL    https://github.com/SebastienForay/Wasabee-IITC-Plugins/raw/main/Kythera/wb-kythera.user.js
...
plugin_info.pluginId = 'wb-kythera';
//END PLUGIN AUTHORS NOTE

// the kythera function is the "worker" of this plugin, called when the toolbox link is clicked
function kythera() {
  ...
  for (const k of Object.keys(window.portals)) {
    ...
    if (d.data.hasOwnProperty("ornaments") && d.data.ornaments.includes("ap1")) {
...
function setup() {
  // this adds the "Wasabee: Kythera Anomaly" link to the IITC toolbox using JQuery syntax
  // the .click(kythera) instructs IITC to call the kythera function (above) when the link is clicked
  $("<a>")
    .html("Wasabee: Kythera Anomaly")
    .attr("title", "Mark Portals with Kythera ornaments")
    .click(kythera)
    .appendTo("#toolbox");
}
